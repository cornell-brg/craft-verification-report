...
technology to test basejump I/O including the \TT{bsg\_comm\_link} interface,
...
source-synchronous signaling protocol used in both the \TT{bsg\_comm\_link} and
